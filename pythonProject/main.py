...
x_max = max([trjs[i]['x'].max() for i in range(num_traj)])
x_min = min([trjs[i]['x'].min() for i in range(num_traj)])
y_max = max([trjs[i]['y'].max() for i in range(num_traj)])
y_min = min([trjs[i]['y'].min() for i in range(num_traj)])
